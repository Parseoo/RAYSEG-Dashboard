...
export function UserMenu({ isOpen, onClose, anchorRef }: UserMenuProps) {
    ...
    return (
        <div ref={menuRef} className="absolute right-0 top-full mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
            ...
            {/* Menu items */}
            <div className="py-2">
                <button type='button' onClick={() => handleNavigation('/settings/my-profile')} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-slate-50 transition-all text-left">
                ...
                <div className="border-t border-gray-200 mt-2 pt-2">
                    <button type='button' onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-red-50 transition-all text-left">
