...
export const inputsDataProperty: InputFieldConfig[] = [
    { type: 'text', id: 'title', label: 'Título de la propiedad', placeholder: 'Ej. Casa moderna de 3 recámaras en El Campestre', required: true },
    {
    ...
    {
        type: 'select', id: 'operation_type', label: 'Operación', placeholder: 'Selecciona tipo de operación', group: 1, options: [], required: true
    },
    { type: 'currency', id: 'price', label: 'Precio', placeholder: 'Ej. 3,500,000', group: 2, required: true, currency: 'MXN' },
    {
        type: 'select', id: 'property_status', label: 'Disponibilidad', placeholder: 'Selecciona disponibilidad', group: 2, options: []
    }
];

export const inputsPublicationProperty: InputFieldConfig[] = [
    {
        type: 'select', id: 'status_publication', label: 'Estado de publicación', placeholder: 'Selecciona un estado de publicación', options: []
    },
    {
