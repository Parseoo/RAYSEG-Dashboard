...
export const inputsDataProperty: InputFieldConfig[] = [
    { type: 'text', 
        ...
        placeholder: 'Ej. Casa moderna de 3 recámaras en El Campestre', 
        required: true 
    },
    {
        type: 'textarea', 
        id: 'description', 
        label: 'Descripción', 
        placeholder: 'Describe las características, distribución, acabados y ventajas de la propiedad.', 
        required: true
    },
    {
        type: 'select', 
...
export const inputsPublicationProperty: InputFieldConfig[] = [
    ...
    },
    {
        ...
        placeholder: 'Agrega una nota para uso interno. No será visible para los clientes.'
    }
];
...
export const inputsDetailProperty: InputFieldConfig[] = [
    ...
    },
    {
        ...
        placeholder: 'Selecciona un tipo de terreno', 
        group: 4, 
        required: true,
        options: []
    },
