...
const AmenitiesManager = ({
    ...
    return (
        <div className="bg-white w-full min-w-full rounded-lg p-5 border border-gray-200">
                ...
                <div className="flex-1 flex flex-col gap-4">
                    <div className="flex items-end gap-4 w-full">
                        ...
                        <button
                            ...
                            className="bg-primary_color text-white w-full sm:w-[200px] h-[42px] rounded-lg flex items-center justify-center gap-2 px-4 hover:opacity-90 transition-opacity font-medium shadow-md shrink-0 disabled:opacity-60"
                        >
                            {isSaving ? (
                                <>
                        ...
                        {editingService && (
                            <button
                                ...
                                className="bg-slate-200 text-gray-700 w-full sm:w-[140px] h-[42px] rounded-lg flex items-center justify-center gap-2 px-4 hover:bg-slate-300 transition-opacity font-medium shrink-0"
                            >
                                Cancelar
                            </button>
                        )}
                        ...
                        <table className="w-full text-left border-collapse bg-white overflow-hidden">
                            <thead>
                                <tr className="bg-slate-100 border-b border-gray-200">
                                    <th className="py-2 px-3 font-medium text-xs text-gray-700 w-16">Icono</th>
                                    <th className="py-2 px-3 font-medium text-xs text-gray-700">Nombre</th>
                                    <th className="py-2 px-3 font-medium text-xs text-gray-700">Descripción</th>
                                    <th className="py-2 px-3 font-medium text-xs text-gray-700 text-right w-24">Acciones</th>
                                </tr>
                            </thead>
                                        ...
                                        <tr key={item.id} className="hover:bg-slate-50 transition-colors border-b border-slate-100">
                                            <td className="py-4 px-4">
                                                <div className="bg-blue-50 p-2 rounded-md inline-flex items-center justify-center">
                                                    {Icon ? <Icon size={16} className="text-blue-500" /> : <LucideIcons.Check size={16} className="text-blue-500" />}
                                                </div>
                                            </td>
                                            ...
                                            <td className="py-4 px-4 text-sm text-right">
                                                <div className="flex justify-end gap-2">
                                                    <button
                                                        ...
                                                        className="p-1.5 bg-slate-200 rounded-md hover:bg-slate-300 transition-colors"
                                                        title="Editar"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-1.5 bg-red-500 rounded-md hover:bg-red-600 transition-colors"
                                                        title="Eliminar"
                                                    >
