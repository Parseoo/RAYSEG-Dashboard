...
const baseInputs: Omit<InputFieldConfig, 'options'>[] = [
    { type: 'text', id: 'street', label: 'Calle', placeholder: 'Blvd. Campestre', required: true },
    { type: 'text', id: 'street_number', label: 'Número', placeholder: '245', group: 1 },
    { type: 'text', id: 'neighborhood', label: 'Colonia', placeholder: 'Jardines del Moral', group: 1 },
    { type: 'number', id: 'postal_code', label: 'Código Postal', placeholder: '37160', group: 1 },
