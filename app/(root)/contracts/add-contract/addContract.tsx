        ...
        <div className='w-full h-full'>
          <div className='flex items-center justify-between mb-3'>
            <div>
              ...
              <p className='text-md text-gray-500 mt-2'>Completa el formulario para dar de alta a un nuevo cliente. Asegúrate de ingresar la información correctamente.</p>
            </div>
          </div>
          <AddDataClient />
          <AddContactClient />
