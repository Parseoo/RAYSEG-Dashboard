      ...
      <div className='bg-white w-full max-h-max rounded-lg p-5 mb-9 shadow-md'>
        <div className='w-full h-full'>
          <div className='flex items-center justify-between mb-3'>
            <div>
              <h1 className='text-black font-[700] text-2xl'>Listado de agentes</h1>
              <p className='text-md text-gray-500'>Gestión de agentes inmobiliarios</p>
            </div>
            <div className='flex items-center gap-4'>
              ...
              <Link href='/agents/add-agent'>
                <button type='button'
                  ...
                  <UserPlus size={20} /> Agregar Agente
                </button>
              </Link>
            </div>
          </div>
